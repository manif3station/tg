...
`cli/poller`, `cli/approve`, `cli/reply`, `cli/unread` are the thin
`d2 tg.*` entrypoints described above; each just wires the relevant
modules together.

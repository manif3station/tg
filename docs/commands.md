...
see `D2TG::Lock::find_other_pollers` below.
...
duration-tiered), floored at the original 300s and capped at 3600s. An
explicitly-passed `model` keeps the flat 300s default unchanged. If

...
# TGT-074: bot_groups's --bot branch and D2TG::Reply::Args::extract_bot_flag
...
{
    eval { D2TG::Reply::Args::extract_bot_flag( '--bot', '--db', 'myalias', '123', 'hello' ) };
...

{
    ...
    my ( $bot_token, @rest ) = D2TG::Reply::Args::extract_bot_flag( '--bot', 'xyz999', '4567', 'hello there' );
...

{
    ...
    my ( $bot_token, @rest ) = D2TG::Reply::Args::extract_bot_flag( '4567', 'hello there' );

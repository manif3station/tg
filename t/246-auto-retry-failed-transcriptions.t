...
# d2 tg.retry-transcription existed. D2TG::Download::auto_retry_failed_transcriptions
...
# D2TG::Download::auto_retry_failed_transcriptions: a successful retry
# removes the row, exactly like a manual retry_failed_transcription would.
{
    ...
    D2TG::Download::auto_retry_failed_transcriptions( 'fake-telegram', $store );
...
# queued - never crashes the caller.
{
    ...
    my $ok = eval { D2TG::Download::auto_retry_failed_transcriptions( 'fake-telegram', $store ); 1 };

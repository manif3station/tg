...

{
    ...
    my $value = D2TG::Config::Flags::shift_flag_value( \@args, '--db/-d' );
...
{
    my @args = ('');
    eval { D2TG::Config::Flags::shift_flag_value( \@args, '--since/--until' ) };

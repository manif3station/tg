...
already called by 8 C<cli/*.pl> scripts beyond C<reply.pl>, so it
isn't really reply-specific logic either. Mirrors
...
TGT-236: centralizes the idiom that 8
C<cli/*.pl> scripts (C<history>, C<attachment>, C<unread>,
C<retry-download>, C<retry-transcription>, C<approve>, C<send>,
C<reply>) each duplicated around L<extract_bot_flag()|/extract_bot_flag(@args)> - the exact
